...
COMMAND_MAP = {
    ...
    'show_mirror_group': 'show mirror group',
    'show_port_isolate_group': 'show port-isolate group',
    'show_erps': 'show erps',
    'show_erps_instance': 'show erps instance {instance_id}',
    'show_erps_statistics': 'show erps statistics',
    'show_eaps': 'show eaps',
    'show_eaps_topology': 'show eaps topology',
    'show_eaps_domain': 'show eaps domain {domain_id}',
