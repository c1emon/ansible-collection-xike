...
Define controller-side parser template injection for modules that need bundled parser templates at runtime without depending on non-Python template files inside Ansible module payloads.
